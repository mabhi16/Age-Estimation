...
def lbl_decode(img_name):
    """Extracts the label from the image path"""
    class_list = ['01 to 10', '11 to 20', '21 to 30', '31 to 40', '41 to 50', '51 to 60', '61 to 70', '71 to 80',
                  '81 to 100']
    temp = img_name.split('.png')[0].split('/')[4]
    if temp in class_list:
        lbl = class_list.index(temp)
        return lbl
